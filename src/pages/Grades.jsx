                                    ...
                                    {grades.length > 0 ? grades.map(g => (
                                        <tr key={g.id} style={{ borderTop: '1px solid var(--glass-border)' }}>
                                            <td style={{ padding: '1.2rem' }}>
                                                ...
                                                <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>ID: #{g.studentId}</div>
                                            </td>
                                            <td style={{ padding: '1.2rem' }}>{g.assignmentName}</td>
                                            <td style={{ padding: '1.2rem', textAlign: 'right' }}>
                                                <div style={{ fontWeight: '700', color: 'var(--primary)' }}>{g.score} / {g.maxScore}</div>
                                                <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>{g.percentage.toFixed(1)}%</div>
                                            </td>
                                        </tr>
                                    )) : (
                                        <tr>
                                            <td colSpan="3" style={{ padding: '3rem', textAlign: 'center', color: 'var(--text-muted)' }}>No grades recorded for this course.</td>
                                        </tr>
                                    )}
                                </tbody>
                            </table>
